            ...
            <div style={{ marginTop: "150px" }}>
                <div className="container">
                    <div className={"d-flex justify-content-between align-items-start "}>
                        <h1 className={"display-4 mb-5 text-capitalize fw-bold " + (isDark ? "text-white" : "text-black")}>{t("popular")}</h1>
                    ...
                    <div className={"d-flex row align-items-stretch my-5"}>
                        {!loading && (
                            Object.keys(popular).map((product) => {
                                if (t(category.toLowerCase()) == t("all") || t(category.toLowerCase()) == t(popular[product].category.toLowerCase())) {
                                    return (
                                        <Product key={product} product={popular[product]} />
                                    )
                                }
                            })
                        )}
